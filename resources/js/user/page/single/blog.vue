            ...
            <div class="position-relative">
                ...
                <div
                    ...
                    <div class="d-flex justify-content-center align-items-center">
                        ...
                        <div class="mx-3"> - </div>
                        <router-link :to="{name: 'singleBlog',params:{id:'1'}}" class="text-decoration-none text-theme">
                            Details
                        </router-link>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="p-3">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <router-link :to="{name: 'singleBlog',params:{id:'1'}}" class="w-100">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="px-2">
                            ...
                            <router-link :to="{name: 'singleBlog',params:{id:'1'}}" class="d-flex justify-content-start align-items-center py-3 text-decoration-none text-secondary background-effect">
                                <span class="col-3">
